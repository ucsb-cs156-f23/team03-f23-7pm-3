...
describe("HelpRequestForm tests", () => {
    ...
    test("renders correctly", async () => {
        ...
        await screen.findByText(/RequestEmail/);
    ...
    test("Correct Error messsages on missing input", async () => {
        ...
        //screen.debug()
        await screen.findByText(/RequestEmail is required./);
        expect(screen.getByText(/RequestEmail is required./)).toBeInTheDocument();
    ...
    test("No Error messsages on good input", async () => {
       ...
       // await screen.findByTestId("UCSBDateForm-quarterYYYYQ");
        ...
        fireEvent.change(teamIdField, { target: { value: 'f23-7pm-3' } });
